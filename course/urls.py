...
from .views import AboutView, CourseListView, ManageCourseListView, CreateCourseView, DeleteCourseView, CreateLessonView, ListLessonView, DetailLessonView, StudentListLessionView
...
#    url(r'about/$', TemplateView.as_view(template_name="course/about.html")),
     ...
     url(r'delete-course/(?P<pk>\d+)/$', DeleteCourseView.as_view(), name='delete-course'),
     ...
     url(r'lessons-list/(?P<course_id>\d+)/$', StudentListLessionView.as_view(), name='lessons-list'),
]